              ...
              <div key={index} className="flex flex-col lg:flex-row w-full ">
                ...
                <div className="mx-auto w-auto lg:w-1/5 px-4 py-8 text-start lg:bg-black z-50">
                  ...
                  <a
                    href={prj.repository}
                    target="_blank"
                    className="flex gap-x-2 items-center pt-4 text-sm lg:text-base text-[var(--white)] hover:text-blue-400 transition-colors duration-300"
                  >
                    <svg
                  ...
                  <a
                    href={prj.repository}
                    target="_blank"
                    className="flex gap-x-2 items-center lg:pt-4 text-sm lg:text-base text-[var(--white)] hover:text-blue-400 transition-colors duration-300"
                  >
                    <svg
                      className="fill-current group-hover:fill-blue-400 p-1 lg:p-0"
                      xmlns="http://www.w3.org/2000/svg"
