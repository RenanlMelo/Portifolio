              ...
              <div className="mx-auto w-auto lg:w-1/5 px-4 py-8 text-start lg:bg-black z-30">
                ...
                <div className="grid grid-cols-2 gap-x-2 items-center justify-evenly pt-4">
                  <a
                    href={prj.repository}
                    target="_blank"
                    className="flex justify-start px-4 py-2 rounded-full border-2 border-[#aaa] gap-x-2 h-full items-center text-base lg:text-sm text-[var(--white)] hover:border-blue-400 hover:text-blue-400 transition-colors duration-300"
                  >
                    <Github size={24} />
                    Repository
                  </a>
                  ...
                  <a
                    href={prj.url}
                    target="_blank"
                    className="flex justify-start gap-x-2 px-4 py-2 rounded-full border-2 border-[#aaa] items-center text-base lg:text-sm text-[var(--white)] hover:border-blue-400 hover:text-blue-400 transition-colors duration-300"
                  >
